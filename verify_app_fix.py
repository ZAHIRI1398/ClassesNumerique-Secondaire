...
def main():
    print("=== Vérification de la correction de l'exercice 2 ===")
    
    # Vérifier la syntaxe de app.py
    print("\n1. Vérification de la syntaxe de app.py...")
    if check_app_py_syntax():
        print("✓ app.py est syntaxiquement correct")
    else:
        print("✗ app.py contient des erreurs de syntaxe")
        return False
    
    # Vérifier que le code de correction est présent
    print("\n2. Vérification du code de correction...")
    if check_fill_in_blanks_code():
        print("✓ Le code de correction du format des mots est présent")
    else:
        print("✗ Le code de correction du format des mots est absent")
        return False
    
    # Vérifier que l'application est en cours d'exécution
    print("\n3. Vérification de l'application en cours d'exécution...")
    if check_app_running():
        print("✓ L'application est en cours d'exécution")
    else:
        print("✗ L'application n'est pas en cours d'exécution")
        print("  Veuillez démarrer l'application avec 'python app.py'")
        return False
    
    # Vérifier que l'exercice 2 est accessible
    print("\n4. Vérification de l'accès à l'exercice 2...")
    if check_exercise_exists():
        print("✓ L'exercice 2 est accessible")
    else:
        print("✗ L'exercice 2 n'est pas accessible")
        print("  Vérifiez que l'exercice existe dans la base de données")
        return False
    ...
    print("✓ L'exercice 2 est accessible")
    print("\nLa correction du problème de format des mots dans l'exercice 2 est complète.")
