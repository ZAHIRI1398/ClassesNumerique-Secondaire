#!/usr/bin/env python3
"""
Script simplifié pour ajouter une route de diagnostic à app.py
"""
...
def add_simple_diagnostic_route():
    """Ajoute une route de diagnostic simplifiée à app.py"""
    app_path = 'app.py'
...
"""
    ...
    temp_path = 'app_with_simple_diagnostic.py'
    with open(temp_path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    
    print(f"Route de diagnostic simplifiée ajoutée avec succès dans {temp_path}!")
