"""
Patch pour intégrer la correction des chemins d'images des exercices de type légende dans app.py.
Ce fichier contient le code à ajouter à app.py pour créer la route de correction des images.
"""

# Importer ce code dans app.py
# ------------------------------
...
def fix_legend_image_paths_route():
    ...
    for exercise in legend_exercises:
        ...
        if not main_image and not image_path:
            ...
            if main_image and main_image.startswith('/static/uploads/'):
                status['status'] = 'ok'
