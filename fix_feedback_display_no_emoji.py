...
def backup_app_py():
    ...
    try:
        ...
        print(f"[OK] Sauvegarde créée: {backup_filename}")
        return True
...
def fix_feedback_template():
    ...
    try:
        ...
        if not fill_in_blanks_block:
            print("[ERREUR] Bloc fill_in_blanks non trouvé dans le template")
            return False
        ...
        print(f"[OK] Template {template_path} modifié avec succès")
        return True
    
    except Exception as e:
        print(f"[ERREUR] Erreur lors de la modification du template: {e}")
        return False
...
def fix_feedback_preparation():
    ...
    try:
        ...
        print(f"[OK] Préparation du feedback modifiée dans app.py")
        return True
...
def main():
    """Fonction principale"""
    print("[INFO] Correction du problème d'affichage du feedback pour les exercices fill_in_blanks avec plusieurs mots par ligne")
    
    # Créer une sauvegarde
    if not backup_app_py():
        print("[ERREUR] Impossible de continuer sans sauvegarde")
        return
    
    # Modifier le template feedback.html
    if not fix_feedback_template():
        print("[ERREUR] Échec de la modification du template")
        return
    
    # Modifier la préparation du feedback dans app.py
    if not fix_feedback_preparation():
        print("[ERREUR] Échec de la modification de app.py")
        return
    
    print("[OK] Modifications terminées avec succès")
    print("[INFO] Veuillez redémarrer l'application Flask pour appliquer les modifications")
