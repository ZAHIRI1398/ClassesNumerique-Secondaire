...
# -*- coding: utf-8 -*-
"""
Script simple pour vérifier les fichiers app.py
"""
    ...
    if os.path.exists(root_app):
        ...
        with open(root_app, 'r', encoding='utf-8') as f:
            ...
            if 'test_upload' in content:
                print("   OK - Contient la route /test_upload")
            else:
                print("   ERREUR - Ne contient PAS la route /test_upload")
    else:
        print("   ERREUR - N'existe pas")
