...
def fix_app_py_scoring_manual():
    ...
    if code_to_replace in content:
        ...
        print("❌ Le bloc de code exact n'a pas été trouvé. Vérification d'un format alternatif...")
        ...
        if match:
            ...
            print("✅ Le fichier app.py a été modifié avec succès (via regex) pour corriger le problème de double comptage.")
            return True
        else:
            print("❌ Impossible de trouver le code à modifier. Veuillez vérifier manuellement.")
...
if __name__ == "__main__":
    ...
    print("\n=== RÉSUMÉ DES ACTIONS ===")
    if success:
        print("✅ Le code de scoring dans app.py a été corrigé avec succès.")
    else:
        print("⚠️ La correction automatique a échoué. Veuillez appliquer les modifications manuellement.")
